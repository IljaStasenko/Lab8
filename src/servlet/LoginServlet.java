...
// ������������ ��� ����� cookie
        ...
        // ������� �����
        pw.println("<form action='/Lab8_3_war_exploded/' method='post'>Введите имя:" +
...
// ����� ������ �������� ����� �����������
        ...
        if (errorMessage!=null) {
            ...
            // �������������� ������� �� �������� �������� � ������
            response.sendRedirect(response.encodeRedirectURL("/Lab8_3_war_exploded/"));
        }
    }
...
// �� ��������� �������������
        ...
        if (aUser.getSessionId().equals(sessionId) ||
            ...
            response.sendRedirect(response.encodeRedirectURL("/Lab8_3_war_exploded/view.htm"));
            // ������� null, �.�. ��������� �� ������� ���
            return null;
        } else {
            // ����������� � ������ ��� ��� ���������� �� ���-�� ������.
